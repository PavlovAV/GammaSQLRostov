...
CREATE VIEW [dbo].[vRobotPalletsInsertToGamma]
AS
SELECT DISTINCT  p.STGCode AS Number, p.STGCode AS Barcode, p.InsertDate AS Date, 
  ...
  rp.PlaceID AS PlaceID, u.Coefficient AS Quantity, p.EAN, p.ErrorInsertedToGamma
...
RIGHT JOIN [dbo].[RobotProduct1CCharacteristic] rc ON rc.[1CCharCode] = c.[1CCode]
RIGHT JOIN [MSTR1].[RobotActivation].[dbo].[StoricoPalletForInsertToGamma] p ON p.ProdNumber = rc.ProdNumber
LEFT JOIN vRobotPlaces rp ON rp.RobotLineID = p.ProductionLine
WHERE p.DateInsertedToGamma IS NULL
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Wrapper]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [OperatorRW]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [OperatorBDM]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [TechnologSGB]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Engineer]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Dispetcher]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [QualityInspector]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [OperatorConverting]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [TechnologSGI]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [WarehouseOperator]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Loader]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Baler]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [Viewer]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vRobotPalletsInsertToGamma] TO [PalletRepacker]
    AS [dbo];
