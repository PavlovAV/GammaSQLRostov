...
GO
CREATE TRIGGER [dbo].[zzdDocInProducts] ON DocInProducts
AFTER  DELETE AS 
...
GO
CREATE TRIGGER [dbo].[zzuDocInProducts] ON DocInProducts
AFTER  UPDATE AS 
INSERT INTO zzDocInProducts
...
GO
CREATE TRIGGER [dbo].[zziDocInProducts] ON DocInProducts
AFTER  INSERT AS 
INSERT INTO zzDocInProducts
